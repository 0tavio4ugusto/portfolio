  ...
  return(
      ...
      <div className="m-5 mx-20 bg-black rounded-full bg-opacity-5 flex flex-row justify-around min-w-min"> 
        ...
        <div className="flex flex-col justify-evenly text-purple-900 text-2xl font-black flex-[1_1_0%]">
          ...
          <div className="flex-wrap self-center w-4/5 text-center text-lg mt-4 font-black text-purple-700">
            {props.LowerText}
          </div> 

          <a  target="_blank" className="w-40 h-12 bg-purple-900 text-yellow-100 flex justify-center rounded-xl self-center cursor-pointer hover:bg-purple-800 hover:scale-110 transition-all" href={props.Git}>
